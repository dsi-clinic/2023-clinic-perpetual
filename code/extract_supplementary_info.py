# produce supplementary info about each point (used for the popups during mapping)
...
if __name__ == '__main__':
    ...
    supp_info = truth_df[['Name', 'Daily_Pickup_Totes', 'Weekly_Dropoff_Totes', 'category', 'Address', 'location_type', 'pickup_type']]
