...
def main():
    ...
    path_to_routes = config["optimize google cvrp"][
    "output_path"
    ]
    num_routes = config["optimize google cvrp"][
    "num_vehicles"
    ].astype(int)

    #use these arguments to call the function extract_route_info
    load_per_vehicle, locations_per_vehicle, distance_per_vehicle = extract_route_info(path_to_routes, num_routes) 
    ...
    trial_dict['trial_name'] = config["feasibility report"][
    "trial_name"
    ]  
    trial_dict['description'] = config["feasibility report"][
    "description"
    ]
    ...
    trial_dict['vehicle_type'] = config["feasibility report"][
    "vehicle_type"
    ]
