...
This is Google OR-Tools' cvrp problem copied and executed exactly
as it appears online

In the terminal, run:
python google_cvrp.py <arg1>
...
def create_data_model():
    ...
    data["distance_matrix"] = [
        ...
        [274, 502, 502, 650, 536, 0, 228, 308, 194, 240, 582, 776, \
         662, 628, 514, 1050, 708],
...
def main():
    ...
    search_parameters.time_limit.FromSeconds(int(sys.argv[1]))
