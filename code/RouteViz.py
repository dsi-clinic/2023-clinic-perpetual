...
if __name__ == '__main__':
    ...
    galv_graph1 = ox.truncate.truncate_graph_bbox(graph, n1, s1, e1, w1, truncate_by_edge=False, retain_all=False, quadrat_width=0.05, min_num=3)
    galv_graph2 = ox.truncate.truncate_graph_bbox(graph, n2, s2, e2, w2, truncate_by_edge=False, retain_all=False, quadrat_width=0.05, min_num=3)
